...
class UserLoginSerializer(serializers.ModelSerializer):
    ...
    password = serializers.CharField(max_length=60, min_length=8, write_only=True)
    full_name = serializers.CharField(max_length=200, read_only=True)
...
#             otp = user.onetimepassword_set.get(code=code)
#             otp.is_used = True
#             otp.save()
...
#             raise serializers.ValidationError("Invalid code. Please try again!")
#         except OneTimePassword.MultipleObjectsReturned:
#             raise serializers.ValidationError("Multiple codes found. Please contact support!")
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            if not PasswordResetTokenGenerator().check_token(user, token):
                raise AuthenticationFailed("Invalid token. Please try again!", 401)
